...
require 'sourced/store/message_codec'
...
module Sourced
  ...
  class PositionedMessage < SimpleDelegator
    ...
    # @param message [Sourced::Message] the wrapped message instance
    ...
    # Unwrap to the underlying {Sourced::Message}. Part of the +to_message+
    # contract honoured by {Sourced::Message.===} so that +case/when+ works
  ...
  # SQLite-backed store for Sourced's flat, globally-ordered message log.
  ...
  class Store
    ...
    # @yieldparam group [Sourced::GroupUpdater]
    # @return [void]
    def updating_consumer_group(group_id)
      ...
      group = Sourced::GroupUpdater.new(group_id, row, logger)
      yield group
    ...
    #   # ]
    #
    # @return [Sourced::Stats] max_position and per-group processing state
    def stats
    ...
    # @return [Sourced::OffsetsResult] paginated offsets with total_count and fetcher for auto-pagination
    ...
    #
    # @param messages [Array<Sourced::Message>] messages being appended
    # @return [void]
