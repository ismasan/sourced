...
module Sourced
  module CCC
    ...
    # adapted to CCC's stream-less messages.
    module React
      PREFIX = 'ccc_reaction'
      EMPTY_ARRAY = [].freeze
      ...
      #
      # @param message_class [Class, Symbol] CCC message class, or a symbol
      #   resolved via <tt>.[]</tt>
      ...
      module ClassMethods
        ...
        # Register a reaction handler for one or more CCC message types.
        #
        ...
        def reaction(*args, &block)
          ...
          in [Symbol => message_symbol]
            ...
            reaction(message_class, &block)
          in [Class => message_class] if message_class < CCC::Message
